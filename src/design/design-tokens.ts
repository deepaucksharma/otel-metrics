...
export const designTokens = {
  ...
  histogramBarColor: "#0078d4",
  histogramHighlightColor: "#f39c12",
  referenceLineColor: "#ffffff",
  axisLabelColor: "var(--textSecondary)",
  ...
  hoverBg: "var(--surfaceBgHover)",
  focusBg: "var(--focusHighlightBg)",
  highlightBgColor: "var(--highlightBg)",
  highlightColor: "var(--statusSuccess)",
  iconGrey: "var(--textTertiary)",
  iconHover: "var(--textPrimary)",
  barTrack: "var(--miniBarBg)",
